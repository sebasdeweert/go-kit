...
// Source: github.com/sebasdeweert/go-kit/encoding (interfaces: Encoder)
...
func (m *MockEncoder) Decode(arg0 string, arg1 interface{}) error {
	m.ctrl.T.Helper()
...
func (m *MockEncoder) Encode(arg0 interface{}) (*string, error) {
	m.ctrl.T.Helper()
